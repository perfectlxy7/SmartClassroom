...
import com.hunau.framework.shiro.service.SysPasswordService;
import com.hunau.framework.util.ShiroUtils;
import com.hunau.system.domain.SysUser;
import com.hunau.system.service.ISysPostService;
...
public class SysUserController extends BaseController
{
    ...
    @Log(title = "用户管理", businessType = BusinessType.EXPORT)
    @RequiresPermissions("system:user:export")
    @PutMapping("/exportbysingle")
    @ResponseBody
    public AjaxResult export(@RequestParam("userId") List<String> userId)
    {
        List<SysUser> list = userService.selectUserByIds(userId);
        ExcelUtil<SysUser> util = new ExcelUtil<SysUser>(SysUser.class);
        return util.exportExcel(list, "用户数据");
    }
    /**
