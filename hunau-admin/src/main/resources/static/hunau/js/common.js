...
var refreshItem = function(){
	...
	var target = $('.hunau_iframe[data-id="' + currentId + '"]', topWindow);
...
var closeItem = function(){
	...
	if($.common.isNotEmpty(panelUrl)){
		...
		$('.mainContent .hunau_iframe', topWindow).each(function() {
...
function createMenuItem(dataUrl, menuName) {
    ...
    if (flag) {
        ...
        // 添加选项卡对应的iframe
        var str1 = '<iframe class="hunau_iframe" name="iframe' + dataIndex + '" width="100%" height="100%" src="' + dataUrl + '" frameborder="0" data-id="' + dataUrl + '" data-panel="' + panelUrl + '" seamless></iframe>';
        $('.mainContent', topWindow).find('iframe.hunau_iframe').hide().parents('.mainContent').append(str1);
