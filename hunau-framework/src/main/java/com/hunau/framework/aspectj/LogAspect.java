package com.hunau.framework.aspectj;
...
import com.hunau.common.enums.BusinessStatus;
import com.hunau.common.json.JSON;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.hunau.common.annotation.Log)")
